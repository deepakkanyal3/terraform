locals {
  ...
  igw_route_table_ids  = aws_route_table.igw[*].id
}
...
output "igw_route_table_ids" {
  description = "List of IDs of ygw route tables"
  value       = local.igw_route_table_ids
}

output "firewall_internet_gateway_route_id" {
  description = "ID of the internet gateway route"
  value       = try(aws_route.firewall_internet_gateway[0].id, null)
}
...
# output "firewall_nat_gateway_route_ids" {
#   description = "List of IDs of the firewall nat gateway route"
#   value       = aws_route.firewall_nat_gateway[*].id
# }

# output "firewall_ipv6_egress_route_ids" {
#   description = "List of IDs of the ipv6 egress route"
#   value       = aws_route.firewall_ipv6_egress[*].id
# }
...
output "backend_subnets" {
  description = "List of IDs of backend subnets"
  value       = aws_subnet.backend[*].id
}

output "backend_subnet_arns" {
  description = "List of ARNs of backend subnets"
  value       = aws_subnet.backend[*].arn
}

output "backend_subnets_cidr_blocks" {
  description = "List of cidr_blocks of backend subnets"
  value       = compact(aws_subnet.backend[*].cidr_block)
}

output "backend_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of backend subnets in an IPv6 enabled VPC"
  value       = compact(aws_subnet.backend[*].ipv6_cidr_block)
}

output "backend_subnet_group" {
  description = "ID of backend subnet group"
  value       = try(aws_db_subnet_group.backend[0].id, null)
}

output "backend_subnet_group_name" {
  description = "Name of backend subnet group"
  value       = try(aws_db_subnet_group.backend[0].name, null)
}

output "backend_route_table_ids" {
  description = "List of IDs of backend route tables"
  value       = try(coalescelist(aws_route_table.backend[*].id, local.private_route_table_ids), [])
}

output "backend_internet_gateway_route_id" {
  description = "ID of the backend internet gateway route"
  value       = try(aws_route.backend_internet_gateway[0].id, null)
}

output "backend_nat_gateway_route_ids" {
  description = "List of IDs of the backend nat gateway route"
  value       = aws_route.backend_nat_gateway[*].id
}

output "backend_ipv6_egress_route_id" {
  description = "ID of the backend IPv6 egress route"
  value       = try(aws_route.backend_ipv6_egress[0].id, null)
}

output "backend_route_table_association_ids" {
  description = "List of IDs of the backend route table association"
  value       = aws_route_table_association.backend[*].id
}

output "backend_network_acl_id" {
  description = "ID of the backend network ACL"
  value       = try(aws_network_acl.backend[0].id, null)
}

output "backend_network_acl_arn" {
  description = "ARN of the backend network ACL"
  value       = try(aws_network_acl.backend[0].arn, null)
}
