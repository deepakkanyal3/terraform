...
variable "producer" {
  description = "this will contain a list of applications which are producing the messages in sqs"
  type        = string
}

variable "consumer" {
  description = "this will contain a list of applications which are consuming from sqs"
  type        = string
}
