...
# #     {
# #     priority     = 10
# #     resource_arn = "${var.aws_network_firewall_prefix}:${var.AWS_REGION}:${var.aws_stateful_rule_prefix}/AbusedLegitBotNetCommandAndControlDomainsStrictOrder"
# #     },
# #     {
# #       priority     = 20
# #       resource_arn = "${var.aws_network_firewall_prefix}:${var.AWS_REGION}:${var.aws_stateful_rule_prefix}/BotNetCommandAndControlDomainsStrictOrder"
# #     },
# #     {
# #       priority     = 30
# #       resource_arn = "${var.aws_network_firewall_prefix}:${var.AWS_REGION}:${var.aws_stateful_rule_prefix}/AbusedLegitMalwareDomainsStrictOrder"
# #     }
# #   ]
